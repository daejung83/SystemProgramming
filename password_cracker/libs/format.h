 ...
 * @timeElapsed: total time in seconds that has elapsed
 * @totalCpuTime: total CPU time used in seconds
 *
 * THIS FUNCTION SHOULD ONLY BE USED IN VERSION 1 OF THIS MP
 */
void v1_print_summary(int numRecovered, int numFailed, double timeElapsed,
                      double totalCPUTime);
